...
def draw_feature_map1(features, img_path, save_dir = '../featuremaps/feature_map_afterneck_refine2_channel/',name = None):
    '''
    ...
    for featuremap in features:     # 循环遍历
        ...
        superimposed_img = heatmap * 0.5 + img * 0.5  # 这里的0.4是热力图强度因子
...
def feature_map_channel(features,img_path,save_dir = '../featuremaps/feature_map_afterneck_refine2_channel/low_level',name = None):
