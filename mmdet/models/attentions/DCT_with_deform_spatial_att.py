...
class DCTChannelAttention(nn.Module):
    def __init__(self, in_planes, ratio=8):
        ...
        c1wh = dict([(256, 52), (512, 26), (1024, 13)])
        self.catt = MultiSpectralAttentionLayer(in_planes, c1wh[in_planes], c1wh[in_planes], reduction=ratio, freq_sel_method='low16')
...
class DCBAM(nn.Module):
    def __init__(self, channel, ratio=8, kernel_size=7):
        ...
        self.channelattention = DCTChannelAttention(channel, ratio=ratio)
