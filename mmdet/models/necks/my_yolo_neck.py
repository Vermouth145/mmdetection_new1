...
class my_YOLOV3Neck(BaseModule):
    """The neck of YOLOV3.
    ...
    def __init__(self,
                 ...
                 act_cfg=dict(type='LeakyReLU', negative_slope=0.1),
                 init_cfg=None):
        super(my_YOLOV3Neck, self).__init__(init_cfg)
        ...
        self.cbam_1 = MCBAM(int(in_channels[0]))
        self.cbam_2 = MCBAM(int(in_channels[1]))
        self.cbam_3 = MCBAM(int(in_channels[2]))
